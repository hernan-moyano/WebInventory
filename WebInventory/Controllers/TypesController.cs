...
namespace WebInventory.Controllers
{
    public class TypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Type,Description")] Models.Type @type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Type,Description")] Models.Type @type)
        {
            if (id != @type.Id_Type)
            {
                return NotFound();
        ...
        {
            return _context.Type.Any(e => e.Id_Type == id);
        }
    }
}
